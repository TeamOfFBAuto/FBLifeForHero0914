...
-(void)bottoming{
    ...
    [self setFrame:CGRectMake(0,DEVICE_HEIGHT - 40, DEVICE_WIDTH, 40)];
...
-(void)uping{
    ...
    [UIView setAnimationDuration:0.3];
    if (IOS_VERSION>=7) {
        [self setFrame:CGRectMake(0,DEVICE_HEIGHT - 275 + 20, DEVICE_WIDTH, 40)];
...
-(void)chinesekeyuping{
    ...
    [UIView setAnimationDuration:0.3];
    if (IOS_VERSION>=7) {
        [self setFrame:CGRectMake(0,DEVICE_HEIGHT - 312 +20, DEVICE_WIDTH, 40)];
...
-(void)jiugonggepinyinuping{
    ...
    [UIView setAnimationDuration:0.3];
    if (IOS_VERSION>=7) {
        [self setFrame:CGRectMake(0,DEVICE_HEIGHT - 275 + 20+216-184, DEVICE_WIDTH, 40)];
...
//    }
    ...
    if (IOS_VERSION>=7) {
        [self setFrame:CGRectMake(0,DEVICE_HEIGHT - 217 +20-55, DEVICE_WIDTH, 40)];
