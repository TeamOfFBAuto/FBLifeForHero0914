...
//    UIImage *sendBack = [[UIImage imageNamed:@"send1"] resizableImageWithCapInsets:insets];
...
//    [sendButton setBackgroundImage:sendBackHighLighted forState:UIControlStateHighlighted];
    ...
    [sendButton setBackgroundImage:[UIImage imageNamed:@"20130502_fabiao.png"] forState:UIControlStateNormal];
    [sendButton setBackgroundImage:[UIImage imageNamed:@"20130502_fabiao.png"] forState:UIControlStateHighlighted];
    [sendButton setBackgroundImage:[UIImage imageNamed:@"20130502_fabiao.png"] forState:UIControlStateDisabled];
...
//    [sendButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
   [sendButton setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    [sendButton setTitleColor:[UIColor colorWithWhite:1.0f alpha:1.0f] forState:UIControlStateDisabled];
//    
    return sendButton;
}
